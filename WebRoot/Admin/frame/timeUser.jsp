						...
						<tbody>
							...
							<s:iterator value="userList" id="u">
								<tr class="alt-row">
									...
									<td><s:property value="#u.usLastlogintime"/></td>
									<td><s:property value="#u.usLogouttime"/></td>
									<td><s:property value="#u.usTotalonlinetime"/></td>
									<td><s:property value="#u.usLastsignin"/></td>
								</tr>
							</s:iterator>
							</form>
						</tbody>
