$(function(){
	...
	$(".act").click(function(){/*
			...
			$myAlert.find("input").eq(0).attr("value",$before.children('td').eq(1).children().text());
			$myAlert.find("input").eq(1).attr("value",$before.children('td').eq(2).text());
			$myAlert.find("input").eq(2).attr("value",$before.children('td').eq(3).children().text());
			
			$myAlert.find("input").eq(3).attr("value",$before.children('td').eq(4).text());
			$myAlert.find("input").eq(4).attr("value",$before.children('td').eq(5).text());
			$myAlert.find("#school").attr("value",$before.children('td').eq(6).children().eq(0).text());
			
			$myAlert.find("input").eq(5).attr("value",$before.children('td').eq(6).children().eq(1).text());
	...
	$(".content-add").click(function(){/*
			...
			$myAlert.find("input").eq(4).attr("value","");
			$myAlert.find("#school").attr("value","");
			
			$myAlert.find("input").eq(5).attr("value","");
