...
<body onload="getStoreGoodsList(1,5,-1,-1,1)">
	...
	<div id="warpper">
		...
		<div>
			<div class="title">
				仓库中的宝贝<span style="font-size:10px">(共10件宝贝)</span> 
			</div>
			<div class="table-center keeping-table">
				<div>
					<ul class="keeping-list">
						<li class="on" onclick="getStoreGoodsList(1,5,-1,-1,1)">未上架</li>
						<li class="out" onclick="getStoreGoodsList(1,5,-1,-1,3)">已下架</li>
					</ul>
				</div>
				<table id="storeGoodslist">
					...
					<!-- <tbody>
						...
						<tr>
							...
							<td>12</td>
							<td><a href="#">12条</a></td>
							<td><a>上架</a> | <a class="revise">编辑</a></td>
...
$(".keeping-list li").click(function(){
    $(this).addClass("on").removeClass("out")
    .siblings().removeClass("on").addClass("out");
});
$(".delete").click(function(){
		var name = $(this).parent().parent().children(".goodsname").html();
		confirm("确定删除“"+name+"”");
