...
<body onload="getStoreGoodsList(1,5,0,1,2)">
	...
	<div id="warpper">
		...
		<div>
			<div class="title">
				出售中的宝贝<span style="font-size:10px">(共10件宝贝)</span> 
			</div>
			<div class="table-center selling-table">
				<table id="storeGoodslist">
					<!--商品id，照片，名称，价格，上架时间，购买次数，商品评价（可进入查看及回复，暂时不进入），修改状态（下架），删除-->
					<tbody>
						<!-- <tr style="border:0">
							<th>id</th>
							<th>照片</th>
